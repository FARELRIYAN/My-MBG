                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="top" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('admin.monitoring.menus')">
                                    {{ __('Data Menu') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('admin.monitoring.complaints')">
                                    {{ __('Data Pengaduan') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    ...
                    <x-nav-link :href="route('gizi.menus.index')" :active="request()->routeIs('gizi.menus.*')">
                        {{ __('Kelola Menu') }}
                    </x-nav-link>
                    @endif

                    @if(auth()->user()->role === 'petugas_pengaduan')
                    <x-nav-link :href="route('pengaduan.complaints.index')" :active="request()->routeIs('pengaduan.complaints.*')">
                        {{ __('Kelola Pengaduan') }}
                    </x-nav-link>
                    @endif
                </div>
